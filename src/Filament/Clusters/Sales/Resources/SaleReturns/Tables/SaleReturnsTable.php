...
namespace Gopos\Filament\Clusters\Sales\Resources\SaleReturns\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                Filter::make('today')
                    ->label(__('Today'))
                    ->query(fn (Builder $query): Builder => $query->whereDate('sale_return_date', today()))
                    ->toggle(),
                QueryBuilder::make()
                    ->constraints([
                        TextConstraint::make('sale_return_number')
                            ->label(__('Return Number')),
                        RelationshipConstraint::make('sale')
                            ->label(__('Sale'))
                        ...
                        DateConstraint::make('sale_return_date')
                            ->label(__('Return Date')),
